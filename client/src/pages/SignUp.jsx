...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (trimmedName !== form.fullName) {
      setForm((prev) => ({ ...prev, fullName: trimmedName }));
    }
  ...
  return (
    <div className="auth-page sign-up-page">
      <div className="auth-container sign-up-layout">
        <aside className="auth-visual-panel sign-up-panel" aria-hidden="true">
          <div className="auth-visual-overlay">
            <span className="auth-visual-badge">FurryNest</span>
            <h3>Find a companion, build a forever home.</h3>
            <p>Create your account and help us rewrite rescue stories.</p>
          </div>
        </aside>
